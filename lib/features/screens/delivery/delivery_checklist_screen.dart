...
import 'package:clean_go_vendor_app/features/screens/delivery/delivery_otp_screen.dart';
...
class _DeliveryChecklistScreenState
    extends State<DeliveryChecklistScreen> {
      ...
      style: TextStyle(fontSize: 16),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                      context, MaterialPageRoute(builder: (context) => DeliveryOtpScreen()),
                );
              },
              child: const Text(
                "Proceed (Partial)",
