...
import 'package:clean_go_vendor_app/features/screens/delivery/delivery_otp_verification_screen.dart';
class DeliveryOtpScreen extends StatefulWidget {
  const DeliveryOtpScreen({super.key});

  @override
  State<DeliveryOtpScreen> createState() =>
      _DeliveryOtpScreenState();
}

class _DeliveryOtpScreenState
    extends State<DeliveryOtpScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    int checkedCount =
        (shirtChecked ? 1 : 0) + (trousersChecked ? 1 : 0);
